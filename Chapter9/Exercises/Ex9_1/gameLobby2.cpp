...
// friend function of the `Player` class that allows a `Player` object
// to be sent to `cout`. Next, update the function that allows a `Lobby`
// object to be sent to `cout` so that it uses your new function for
// sending a `Player` object to `cout`
